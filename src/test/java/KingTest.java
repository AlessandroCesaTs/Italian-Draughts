...
public class KingTest {
    ...
    @Test
    void whiteBecomesKing() throws IllegalTilePlacementException, NoPieceOnWhiteException, AlreadyOccupiedException, CantEatPieceOfSameTeamException, SimplePieceCantGoBackException {
