...
public class KingTest {
    ...
    @Test
    void whiteBecomesKing() throws IllegalTilePlacementException, NoPieceOnWhiteException, OutOfBoundsException {
    ...
    @Test
    void cantEatKing() throws IllegalTilePlacementException, NoPieceOnWhiteException, OutOfBoundsException {
        Board board=new Board();
        Piece whitePiece=board.getPiece(2,2);
        Piece blackPiece1=board.getPiece(5,5);
        Piece blackPiece2=board.getPiece(5,7);
